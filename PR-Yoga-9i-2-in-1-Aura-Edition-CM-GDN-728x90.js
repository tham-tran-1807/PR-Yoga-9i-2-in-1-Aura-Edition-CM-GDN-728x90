...
lib.ssMetadata = [
		{name:"PR_Yoga_9i_2_in_1_Aura_Edition_CM_GDN_728x90_atlas_1", frames: [[945,184,50,50],[0,0,728,90],[0,276,555,90],[0,368,468,90],[557,276,353,90],[569,184,374,90],[711,92,305,90],[470,368,357,86],[470,456,353,84],[0,184,567,90],[0,92,709,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Yoga_9i_2_in_1_Aura_Edition_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRYoga9i2in1AuraEditionCMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(161,0);
	...
	this.instance_2.setTransform(257,3);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(301).to({_off:false},0).to({_off:true},49).wait(40));

	// Frame6
	this.instance_3 = new lib.Frame6();
	this.instance_3.setTransform(268,4);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(249).to({_off:false},0).to({_off:true},52).wait(89));

	// Frame5
	this.instance_4 = new lib.Frame5();
	this.instance_4.setTransform(223,0);
	...
	this.instance_5.setTransform(184,0);
	...
	this.instance_7.setTransform(96,0);
	...
	this.instance_8.setTransform(45,0);
...
// library properties:
lib.properties = {
	id: '080F7452D6D7B24988DE9E3A6515E438',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Yoga_9i_2_in_1_Aura_Edition_CM_GDN_728x90_atlas_1.png", id:"PR_Yoga_9i_2_in_1_Aura_Edition_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['080F7452D6D7B24988DE9E3A6515E438'] = {
